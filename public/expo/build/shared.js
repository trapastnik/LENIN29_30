...
function Stamp({ text = "\u0421\u0415\u041A\u0420\u0415\u0422\u041D\u041E", sub = "\u0420\u0412\u0421\u0420", x = 0, y = 0, rotate = -8, color = theme.redDeep, size = 130, opacity = 0.7 }) {
  ...
  } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: size * 0.15, fontWeight: 700, lineHeight: 1 } }, text), /* @__PURE__ */ React.createElement("div", { style: { fontSize: size * 0.09, marginTop: 6, opacity: 0.85, letterSpacing: ".25em" } }, sub), /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    inset: 8,
...
function ChapterMark({ year, chapter, subtitle, x = 80, y = 80, lang = "ru" }) {
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    textTransform: "uppercase",
    marginBottom: 18
  } }, chapter), /* @__PURE__ */ React.createElement("div", { style: {
    fontSize: 210,
    fontWeight: 400,
    lineHeight: 0.85,
  ...
  } }, year), /* @__PURE__ */ React.createElement("div", { style: {
    fontSize: 34,
    marginTop: 22,
    color: theme.inkSoft,
...
function Vernier({ time, duration, playing, onPlayPause, onSeek, onHover, years }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    playing ? /* @__PURE__ */ React.createElement("svg", { width: "30", height: "30", viewBox: "0 0 30 30" }, /* @__PURE__ */ React.createElement("rect", { x: "8", y: "6", width: "5", height: "18", fill: "currentColor" }), /* @__PURE__ */ React.createElement("rect", { x: "17", y: "6", width: "5", height: "18", fill: "currentColor" })) : /* @__PURE__ */ React.createElement("svg", { width: "30", height: "30", viewBox: "0 0 30 30" }, /* @__PURE__ */ React.createElement("path", { d: "M8 5l17 10-17 10V5z", fill: "currentColor" }))
  ), /* @__PURE__ */ React.createElement(
    "div",
    {
      ref: trackRef,
    ...
    years.map((y, i) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: y, style: {
        position: "absolute",
        ...
        alignItems: "center",
        pointerEvents: "none"
      } }, /* @__PURE__ */ React.createElement("div", { style: { width: 2, height: 44, background: theme.gold, opacity: 0.7 } }), /* @__PURE__ */ React.createElement("div", { style: {
        marginTop: 6,
        fontFamily: fonts.mono,
        fontSize: 18,
        color: theme.gold,
...
function TopBar({ lang, setLang, direction, setDirection, directions, onOpenSection }) {
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    fontSize: 40,
    fontWeight: 700
  } }, "\u041B"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, letterSpacing: "0.3em", textTransform: "uppercase", fontFamily: fonts.mono, color: theme.inkFaint } }, lang === "ru" ? "\u0413\u043E\u0441\u0443\u0434\u0430\u0440\u0441\u0442\u0432\u0435\u043D\u043D\u044B\u0439 \u043C\u0443\u0437\u0435\u0439 \u0412.\u0418. \u041B\u0435\u043D\u0438\u043D\u0430" : "V.I. Lenin State Museum"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 36, fontFamily: fonts.display, marginTop: 4, letterSpacing: "-0.01em" } }, lang === "ru" ? "\u0413\u0440\u0430\u0436\u0434\u0430\u043D\u0441\u043A\u0430\u044F \u0432\u043E\u0439\u043D\u0430 \xB7 1918\u20141922" : "Civil War \xB7 1918\u20141922"))), /* @__PURE__ */ React.createElement("div", { style: {
    display: "flex",
    gap: 6,
    ...
    borderRadius: 40,
    padding: 5
  } }, directions.map((d) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: d.id,
    ...
    {
      key: link.section,
      onClick: () => onOpenSection && onOpenSection(link.section, link.src),
      style: {
        padding: "14px 20px",
        fontFamily: fonts.mono,
        fontSize: 15,
    ...
    /* @__PURE__ */ React.createElement("span", null, lang === "ru" ? link.ru : link.en),
    /* @__PURE__ */ React.createElement("span", { style: { opacity: 0.55 } }, "\u2192")
  ))), /* @__PURE__ */ React.createElement(
    "a",
    {
      href: "../brand.html",
    ...
    overflow: "hidden",
    fontFamily: fonts.mono
  } }, ["ru", "en"].map((l) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: l,
      onClick: () => setLang(l),
...
function DustParticles({ count = 30 }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, pointerEvents: "none", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("style", null, `
        @keyframes dustFloat {
      ...
      `), particles.map((p) => /* @__PURE__ */ React.createElement("div", { key: p.id, style: {
    position: "absolute",
    left: `${p.x}%`,
    top: `${p.y}%`,
    width: p.size,
