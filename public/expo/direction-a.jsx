...
// paperBg, woodBg, ChapterMark, QuoteCard, Stamp приходят из shared.jsx —
// он объявляет их на верхнем уровне своего <script>, а такие объявления видны
// всем следующим скриптам страницы. Переобъявлять их здесь нельзя: одно имя
// в двух файлах = SyntaxError. Берём из window только то, что переименовываем.
