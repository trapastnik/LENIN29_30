...
// `theme.*` — тёплый слой design-pass-1 поверх бренда.
//
// ⚠️ Тёплый слой помечен в tokens.json как deprecated: paper там #e6d6b5
// против бренд-RAL #F7F9EF, inkSoft #2a1f16 против #2a2f33. Держался он
// ради направлений A/B/C — те удалены 2026-08-04, и слой снимает зона
// design следующим шагом. До тех пор ключи не трогать: их читает этот файл.
//
