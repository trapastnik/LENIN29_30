...
const theme = {
  // Архивная палитра
  ink:         '#2a1f16',    // почти чёрный, с оттенком жжёной умбры
  inkSoft:     '#4a3826',    // подзаголовки
  inkFaint:    '#7a6650',    // мета
  paperLight:  '#efe4cd',    // светлая бумага
  ...
  red:         '#a11b1b',    // красный (знамя, штамп, армия красных)
  redDeep:     '#6b0d0d',
  white:       '#f7f1e1',    // "белая" армия (слоновая кость)
