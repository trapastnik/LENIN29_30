...
// Именуем всё с суффиксом — top-level const у классических <script> общий на
// страницу, одинаковое имя в двух файлах сцены = SyntaxError. (Раньше это
// прятал Babel: пресет env опускал const до var, а var переобъявлять можно.)
