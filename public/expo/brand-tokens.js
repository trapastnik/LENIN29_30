...
(function () {
  ...
  var GROUPS = [
    ...
    {"id":"camp","title":"Палитра лагерей","css":true,"tokens":["camp-red","camp-red-deep","camp-white","camp-rev-dem","camp-green","camp-national","camp-intervention"],"comment":"Выровнено с брендом там, где это возможно."},
