...
(function () {
  ...
  var META = {
    ...
    "scene-bg": {"group":"halftone","css":true,"note":"фон сцены /expo/: было #0a0502 (ΔE 1.19) и #050301 (ΔE 0.56) — глазом один цвет"},
    "scene-ink": {"group":"halftone","css":true,"note":"текст сцены: было #f0dcae, ΔE 4.16; контраст на фоне 13.69 против 15.02"},
    ...
    "map-front": {"group":"map","css":true,"note":"линия фронта. Дата кодируется штрихом, а не цветом: цвет занят стороной"},
