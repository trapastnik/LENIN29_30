...
# Два файла в content-src/ — не моя зона по §4, они выданы точечно заданием
# (docs/launch/m1e-simbirsk.md) под реестр медиа-долга; всё остальное там
# принадлежит зоне content и трогать его нельзя.
ALLOWED_WRITES = (
