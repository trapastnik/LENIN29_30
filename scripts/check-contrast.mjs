...
const СБОР = (подготовка, самопроверка) => `(async () => {
  ...
  // (#efe7d2) на такой же светлой плашке. Инструмент ОБЯЗАН его покраснить;
  // если не покраснел — он сэмплит не ту область, и его молчание ничего
  // не значит (как проба maps, «не поймавшая окно, печатает успех»).
  {
    ...
    проба.style.cssText = 'position:fixed;left:40px;top:40px;z-index:99999;'
      + 'background:#f2ead6;color:#efe7d2;font-size:24px;padding:8px 16px;font-family:sans-serif';
