...
// direction-a/b/c.jsx здесь нет — и самих файлов больше нет. Это были
// заготовки design-pass: «стол коменданта», «карта фронтов», «поток
// документов», между которыми переключался посетитель. По ТЗ выбора
// направления на главной нет, экран собирается из таймлайна и плиток
// разделов, поэтому сперва их сняли с загрузки, а 2026-08-04 удалили
// совсем: никем не грузились, но копировались в dist сырым JSX и ехали
// на киоск — 112 КБ. Плюс несли 148 нарушений R1 из 367, то есть сорок
// процентов долга линтера, чистить который было бы выброшенной работой.
// Оригиналы целы и лежат НЕ здесь — в дизайн-системе проекта как
// variant-A…E.jsx. Следом зона design снимает тёплый слой палитры:
// он держался ровно ради этих трёх файлов.
